...
| Phase                                  | Scope                                                                                                                                                                                                                                                                                                                     | Status     |
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| **1 — Core**                           | License activation (Ed25519 + `py-machineid`), Launcher, FastAPI scaffold with `lifespan`, Alembic, Async SQLAlchemy + WAL pragmas (`busy_timeout=5000`), WoL boot, session API, seat dashboard, Electron agent with hardened kiosk overlay (Windows first), WebSocket with `agent_secret` auth, local SQLite persistence | ✅ Done |
| **2 — Billing, POS & Printing**        | Time billing, food/drink POS, inventory tracking, receipt printing, audit log, integer paise precision                                                                                                                                                                                                                    | ✅ Done |
