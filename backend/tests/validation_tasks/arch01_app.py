...
uvicorn arch01_app:app --host 127.0.0.1 --port 8001 --reload
...
# 5. Run stress test
python arch01_stress_test.py

# Expected output:
# PASS: All 200 concurrent write requests completed without database locking errors.
